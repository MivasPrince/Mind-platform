...
# After st.rerun() from login, this will catch and redirect
        ...
        if submit_button:
            if not email or not password:
                ...
                if login(email, password):
                    # Login successful - trigger rerun to fresh execution
                    st.success(f"✅ Welcome, {st.session_state.user_name}!")
                    st.rerun()  # Fresh execution where st.switch_page is allowed
                else:
